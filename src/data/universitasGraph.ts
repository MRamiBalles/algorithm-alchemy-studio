...
export const graphData = {
    ...
    nodes: [
        ...
        // ─── LEVEL 3: LEGENDARY ───
        { id: "APEX_MBHB", group: "LEGENDARY", label: "MBHB", level: 3, color: "#FF0000", size: 20, role: "legendary", route: "/mbhb", description: "Metaheurísticas y Modelos Bioinspirados. La síntesis de optimización, computación evolutiva y heurísticas de búsqueda.", canonicalText: "Metaheuristics: From Design to Implementation (El-Ghazali Talbi)" },
    ] as GraphNode[],
