            ...
            <header className="border-b border-border/40 bg-card/10 backdrop-blur-md sticky top-0 z-50">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <nav className="flex gap-4 text-sm font-medium text-muted-foreground">
                        <a href="https://github.com/ramiballes" target="_blank" className="hover:text-foreground transition-colors">GitHub</a>
                        <a href="mailto:ramiballes96@gmail.com" className="hover:text-foreground transition-colors">Contact</a>
                    </nav>
                </div>
            </header>
            ...
            <main className="flex-1 container mx-auto px-4 py-12 md:py-20">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight text-foreground">
                        Ingeniería para <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-600">Humanos</span>.
                    </h1>
                    <p className="text-xl text-muted-foreground">
                        Plataforma de aprendizaje visual interactiva. Olvida las fórmulas áridas; toca, juega y entiende la complejidad.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    ...
                    <Card className="group relative overflow-hidden border-cyan-500/30 bg-card/40 hover:bg-card/60 transition-all hover:shadow-2xl hover:shadow-cyan-500/10">
                        ...
                        <CardHeader>
                            <div className="flex justify-between items-start mb-2">
                                <Badge variant="default" className="bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 border-cyan-500/50">
                                    Disponible
                                </Badge>
                                <Brain className="w-8 h-8 text-cyan-400" />
                            </div>
                            <CardTitle className="text-2xl">Heurísticas y Bioinspirados</CardTitle>
                            <CardDescription>Optimización Combinatoria Avanzada</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <p className="text-muted-foreground mb-4">
                                Domina algoritmos genéticos, recocido simulado, búsqueda tabú y colonias de hormigas con visualizadores en tiempo real.
                            </p>
                            <div className="flex gap-2 flex-wrap">
                                <Badge variant="outline" className="text-xs">NP-Hard</Badge>
                                <Badge variant="outline" className="text-xs">TSP/QAP</Badge>
                                <Badge variant="outline" className="text-xs">IA Clásica</Badge>
                            </div>
                        </CardContent>
                        <CardFooter>
                    ...
                    <Card className="group border-border/50 bg-card/20 opacity-75 grayscale hover:grayscale-0 transition-all">
                        ...
                        <CardContent>
                            <p className="text-muted-foreground mb-4">
                                Visualización geométrica de derivadas, integrales y series. Entiende el cambio continuo sin perderte en el álgebra.
                            </p>
                        </CardContent>
                        <CardFooter>
